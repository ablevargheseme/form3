...
//           <Link href='/newapplet'><button className="bg-[#0075FF] md:p-3 p-2 md:px-7 px-5 font-semibold text-lg rounded-xl">CREATE NEW APPLET</button></Link>
//         </div>
//       </div>
...
//           <h3 className="mb-4 text-2xl font-semibold">Applet name</h3>
...
//               <span>ID :</span>
//               <span>#1E4VBSBA1FF</span>
//             </li>
//             <li className="flex items-center space-x-3">
//               <svg className="flex-shrink-0 w-5 h-5 text-green-500 dark:text-green-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path></svg>
//               <span>Status:</span>
//               {isChecked ? <span className="ml-3 text-sm font-medium text-blue-600">Enabled</span> : <span className="ml-3 text-sm font-medium text-gray-900 dark:text-gray-500">Disabled</span>}
//             </li>
//           </ul>
...
// export async function fetchAppletData() {
//   // const { address, isConnecting, isDisconnected } = useAccount()
//   try {
...
//   } catch (error) {
//     console.error('Error fetching applet data:', error);
  ...
  useEffect(() => {
    ...
    async function fetchData() {
      try {
        ...
        setAppletData(data.documents); // Set the fetched data to state
